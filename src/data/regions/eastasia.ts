...
export const EAST_ASIA_ENTITIES: HistoricalEntity[] = [
  ...
  },
  {
    ...
    snapshots: [
      snap(ce(618).year, poly([[82, 28], [87, 29.5], [92, 30], [90, 27], [85, 27.5], [82, 28]]), 'low', 'Songtsen Gampo’s founding unification of the Tibetan Plateau.'),
  ...
  },
  {
    id: 'sakya-tibet',
    name: 'Sakya Tibet',
    alternativeNames: ['Sakya Dynasty'],
    category: 'kingdom',
    start: ce(1254),
    end: ce(1354),
    confidence: 'low',
    colour: '#9a7a6a',
    labelImportance: 2,
    successorIds: ['phagmodrupa'],
    description:
      'The first reunification of Tibet since the empire’s 842 collapse, four centuries of fragmentation later: Kublai Khan installed the Sakya lama Drogön Chögyal Phagpa as ruler of Tibet’s "thirteen myriarchies" under Mongol Yuan overlordship, beginning the "patron-priest" model of Tibetan governance. Overthrown in 1354 by Tai Situ Changchub Gyaltsen.',
    sources: [src('Petech 1990, Central Tibet and the Mongols')],
    snapshots: [
      snap(ce(1254).year, poly([[78, 29], [82, 32], [88, 34], [95, 33], [100, 30], [98, 26], [92, 26], [85, 27], [78, 29]]), 'low', 'Phagpa’s installation as ruler of Tibet under Yuan Mongol suzerainty, approximate.'),
      snap(ce(1300).year, poly([[78, 29], [82, 32], [88, 34], [95, 33], [100, 30], [98, 26], [92, 26], [85, 27], [78, 29]]), 'low', 'Stable Sakya-Mongol rule across the Tibetan Plateau.'),
    ],
  },
  {
    id: 'phagmodrupa',
    ...
    colour: '#8a6a7a',
    labelImportance: 2,
    successorIds: ['ganden-phodrang'],
    description:
      'Tai Situ Changchub Gyaltsen’s overthrow of Sakya rule (1354) restored native Tibetan rule and a lasting legal and administrative order. Regional strongmen increasingly eclipsed the central authority from the mid-15th century — first the Rinpungpa princes of Tsang, then the Tsangpa kings from 1565 — leaving the Phagmodrupa title a shrinking formality before it lapsed entirely in 1618.',
    sources: [src('Petech 1990, Central Tibet and the Mongols')],
    snapshots: [
      snap(ce(1354).year, poly([[78, 29], [82, 32], [88, 34], [95, 33], [100, 30], [98, 26], [92, 26], [85, 27], [78, 29]]), 'low', 'Changchub Gyaltsen reunifies Tibet under native rule.'),
      snap(ce(1435).year, poly([[89, 28.5], [92, 30], [94, 31.5], [93, 28], [90, 27.5], [89, 28.5]]), 'medium', 'The rising Rinpungpa princes of Tsang eclipse central authority, reducing effective Phagmodrupa control to Ü province around Lhasa.'),
      snap(ce(1565).year, poly([[90, 28.7], [91.8, 29.8], [93, 30.5], [92, 28.2], [90.5, 28], [90, 28.7]]), 'medium', 'The Tsangpa dynasty formally supplants the Rinpungpa in Tsang, reducing Phagmodrupa rule to a nominal remnant.'),
      snap(ce(1618).year, poly([[90.5, 29.0], [91.0, 29.9], [92.2, 29.0], [91, 28.5], [90.5, 29.0]]), 'high', 'A final sliver around Lhasa before the Tsangpa kings extinguish Phagmodrupa authority outright.'),
    ],
  },
  {
    id: 'ganden-phodrang',
    name: 'Ganden Phodrang',
    alternativeNames: ['Tibet under the Dalai Lamas'],
    category: 'kingdom',
    start: ce(1642),
    end: ce(1950),
    confidence: 'medium',
    colour: '#7a6a9a',
    labelImportance: 3,
    predecessorIds: ['phagmodrupa'],
    successorIds: ['china-prc'],
    description:
      'The 5th Dalai Lama’s government, installed by Güshi Khan’s Khoshut Mongol army after it crushed the Tsangpa kings (1642), reunified Tibet under the Dalai Lamas for the next three centuries. A Qing Chinese protectorate from 1720 (after expelling a Dzungar Mongol invasion) gave way to effective independence following the 1911 fall of the Qing, before the People’s Liberation Army’s 1950 invasion and the 1951 Seventeen Point Agreement ended Tibetan self-rule.',
    sources: [
      src('Shakabpa 1967, Tibet: A Political History'),
      src('Goldstein 1989, A History of Modern Tibet, 1913–1951'),
    ],
    snapshots: [
      snap(ce(1642).year, poly([[78, 29], [82, 32], [88, 34], [95, 33], [100, 30], [98, 26], [92, 26], [85, 27], [78, 29]]), 'medium', 'The 5th Dalai Lama’s reunification of Tibet with Güshi Khan’s military backing.'),
      snap(ce(1720).year, poly([[78, 29], [82, 32], [88, 34], [95, 33], [100, 30], [98, 26], [92, 26], [85, 27], [78, 29]]), 'high', 'A Qing garrison expels a Dzungar Mongol invasion, beginning a Qing protectorate.'),
      snap(ce(1913).year, poly([[78, 29], [82, 32], [88, 34], [95, 33], [100, 30], [98, 26], [92, 26], [85, 27], [78, 29]]), 'high', 'The 13th Dalai Lama declares Tibetan independence after the Qing dynasty’s 1911 collapse.'),
      snap(ce(1950).year, poly([[78, 29], [82, 32], [88, 34], [95, 33], [100, 30], [98, 26], [92, 26], [85, 27], [78, 29]]), 'high', 'On the eve of the People’s Liberation Army’s invasion, which ends Tibetan self-rule within the year.'),
    ],
  },
