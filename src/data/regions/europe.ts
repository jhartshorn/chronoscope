...
export const EUROPE_ENTITIES: HistoricalEntity[] = [
  ...
  },
  {
    ...
    alternativeNames: ['Kraljevstvo Hrvatska'],
    category: 'kingdom',
    start: ce(925),
    end: ce(1102),
    confidence: 'low',
    colour: '#a86a5a',
    labelImportance: 2,
    successorIds: ['kingdom-of-hungary'],
    description:
      'A medieval Slavic kingdom on the Adriatic, traditionally dated from Tomislav\'s coronation in 925. King Petar Krešimir IV (r. 1058–74) brought it to its territorial height, styling himself ruler "almost of all Dalmatia and Croatia" as Byzantine authority over the Dalmatian coastal cities lapsed. After the death of the last native king, Coloman of Hungary was crowned king in 1102 (traditionally the "Pacta Conventa"), beginning eight centuries of union with the Hungarian and then Habsburg crowns.',
    sources: [
      src('Fine 1983, The Early Medieval Balkans'),
      src('Budak 1994, Prva stoljeća Hrvatske'),
    ],
    snapshots: [
      snap(ce(925).year, poly([[15, 45.7], [16.5, 46.3], [18, 45.8], [17.5, 44.8], [16, 44], [15, 44], [14.8, 45], [15, 45.7]]), 'low', 'Tomislav\'s kingdom (925): inland Pannonian and coastal Dalmatian Croatia, approximate; the Dalmatian city-communes (Split, Zadar, Dubrovnik) remain nominally Byzantine.'),
      snap(ce(1069).year, poly([[13.8, 45.2], [15, 46.3], [16.8, 46.5], [18.5, 45.8], [18, 44.8], [17, 43.7], [15.5, 43], [14, 44], [13.5, 44.7], [13.8, 45.2]]), 'low', 'Petar Krešimir IV\'s peak (r. 1058–74): the kingdom reaches "from the Drava to the Adriatic" as Byzantine control of the Dalmatian coast lapses.'),
      snap(ce(1102).year, poly([[13.8, 45.2], [15, 46.3], [16.8, 46.5], [18.5, 45.8], [18, 44.8], [17, 43.7], [15.5, 43], [14, 44], [13.5, 44.7], [13.8, 45.2]]), 'low', 'Coloman of Hungary crowned king (1102): Croatia enters personal union with Hungary.'),
    ],
  },
  {
    id: 'kingdom-of-bosnia',
    name: 'Kingdom of Bosnia',
    alternativeNames: ['Banate of Bosnia'],
    category: 'kingdom',
    start: ce(1154),
    end: ce(1463),
    confidence: 'low',
    ...
    successorIds: ['ottoman-empire'],
    description:
      'A Balkan state in the Bosna river valley, first attested under Ban Borić around 1154. Ban Kulin\'s long, prosperous rule (1180–1204) is remembered as a golden age; Ban Stephen II Kotromanić added Hum (Herzegovina) and a stretch of Adriatic coast in the 1320s. Tvrtko I, crowned King of Bosnia and Serbia in 1377, brought the kingdom to its greatest extent, briefly styling himself king of Dalmatia and Croatia too. Weakened by succession disputes and a fracturing nobility (the semi-independent "Herzeg" of St Sava splitting off Herzegovina from the 1440s), the kingdom fell to the Ottomans in 1463 with the capture of Bobovac and the execution of the last king, Stephen Tomašević.',
    sources: [
      src('Fine 1994, The Late Medieval Balkans'),
      src('Malcolm 1994, Bosnia: A Short History'),
    ],
    snapshots: [
      snap(ce(1154).year, poly([[17.5, 44.3], [18.5, 44.6], [19, 44], [18.7, 43.3], [17.8, 43.3], [17.3, 43.8], [17.5, 44.3]]), 'low', 'Ban Borić, first attested Ban of Bosnia (c. 1154): the core Bosna valley, approximate.'),
      snap(ce(1180).year, poly([[17.3, 44.4], [18.6, 44.7], [19.2, 44.1], [18.8, 43.2], [17.7, 43.1], [17.1, 43.7], [17.3, 44.4]]), 'low', 'Ban Kulin\'s long, prosperous reign (1180–1204), commemorated in the 1189 Charter of Kulin.'),
      snap(ce(1322).year, poly([[17.3, 44.5], [18.7, 44.8], [19.3, 44.2], [19, 43.3], [18.3, 42.6], [17.6, 42.85], [17.0, 43.3], [16.9, 44], [17.3, 44.5]]), 'medium', 'Ban Stephen II Kotromanić annexes Hum (Herzegovina), reaching the Adriatic near Ston.'),
      snap(ce(1377).year, poly([[16.8, 44.8], [18, 45.3], [19.5, 44.9], [20.3, 44], [19.7, 42.8], [18.3, 42.2], [17, 42.7], [16.3, 43.5], [16.8, 44.8]]), 'medium', 'Tvrtko I crowned King of Bosnia and Serbia (1377), expanding east into Serbian lands.'),
      snap(ce(1391).year, poly([[15.8, 44.9], [17, 45.3], [18.5, 45.5], [19.8, 45], [20.3, 44], [19.7, 42.8], [18.3, 42.2], [17, 42.7], [16, 43.3], [15.5, 44.2], [15.8, 44.9]]), 'medium', 'Peak extent at Tvrtko\'s death (1391): briefly holding parts of the Dalmatian coast and the title "King of Dalmatia, Croatia and Bosnia".'),
      snap(ce(1448).year, poly([[17, 44.6], [18.3, 44.9], [19.2, 44.2], [18.8, 43.2], [17.8, 43.1], [17, 43.8], [17, 44.6]]), 'high', 'The kingdom contracts to its Bosnian core as Herzegovina splits off under the semi-independent "Herzeg" of St Sava and Ottoman vassalage tightens, on the eve of the 1463 conquest.'),
    ],
  },
  {
    id: 'serbian-empire',
