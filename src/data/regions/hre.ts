...
export const HRE_ENTITIES: HistoricalEntity[] = [
  ...
  },
  {
    ...
    colour: '#5a5a8a',
    labelImportance: 2,
    successorIds: ['kingdom-of-prussia'],
    description:
  ...
  },
  {
    ...
    alternativeNames: ['Brandenburg-Prussia', 'Königreich Preußen'],
    category: 'kingdom',
    start: ce(1701),
    end: ce(1871),
    confidence: 'medium',
    colour: '#3a3a6a',
    labelImportance: 4,
    predecessorIds: ['brandenburg'],
    successorIds: ['germany'],
    description:
      'Elector Frederick III of Brandenburg crowned himself "King in Prussia" at Königsberg in 1701, joining Brandenburg to the separate Duchy of Prussia beyond Poland. Frederick the Great seized Silesia from Austria in the 1740s, and the Polish partitions (1772, 1793, 1795) knit the realm into a single contiguous block reaching Warsaw. Napoleon\'s 1807 Treaty of Tilsit stripped away roughly half of it, but the 1815 Congress of Vienna rebuilt Prussia around a new western bloc — the Rhineland and Westphalia — either side of the smaller German states. The 1866 Austro-Prussian War annexed Hanover, Hesse-Kassel, Nassau and Schleswig-Holstein, fusing the two halves into one state that unified Germany under its crown in 1871.',
    sources: [
      src('Clark 2006, Iron Kingdom: The Rise and Downfall of Prussia'),
      src('Wilson 2016, Heart of Europe: A History of the Holy Roman Empire'),
    ],
    snapshots: [
      snap(ce(1701).year, mpoly(
        [[11.8, 52.1], [13, 53], [14.5, 53.5], [15.5, 53.7], [16, 52.8], [15, 52.6], [15, 51.8], [13.5, 51.8], [12, 51.8], [11.8, 52.1]],
        [[19, 54.8], [21, 55.2], [22.5, 54.7], [21, 53.5], [19.5, 53.5], [19, 54.8]],
      ), 'medium', 'Frederick I crowned "King in Prussia" at Königsberg, 1701: Brandenburg united with the separate Duchy of Prussia, an exclave beyond Polish Royal Prussia.'),
      snap(ce(1742).year, mpoly(
        [[11.8, 52.1], [13, 53], [14.5, 53.5], [15.5, 53.7], [16, 52.8], [15, 52.6], [15, 51.8],
         [16.5, 51.6], [17.5, 51.1], [18.3, 50.6], [18.6, 50.2],
         [17.3, 50.0], [16.2, 50.3], [15.2, 50.6], [14.7, 50.9],
         [13.5, 51.8], [12, 51.8], [11.8, 52.1]],
        [[19, 54.8], [21, 55.2], [22.5, 54.7], [21, 53.5], [19.5, 53.5], [19, 54.8]],
      ), 'high', 'Frederick the Great seizes Silesia from Austria in the First Silesian War, confirmed by the Treaty of Berlin (1742).'),
      snap(ce(1772).year, poly([
        [11.8, 52.1], [13, 53], [14.5, 53.7], [16, 54.3], [17.3, 54.5], [18.3, 54.6], [19.5, 54.8],
        [21, 55.2], [22.5, 54.7], [21, 53.5],
        [19.5, 53.0], [18.0, 52.6], [16.5, 52.6], [15, 52.6],
        [15, 51.8], [16.5, 51.6], [17.5, 51.1], [18.3, 50.6], [18.6, 50.2],
        [17.3, 50.0], [16.2, 50.3], [15.2, 50.6], [14.7, 50.9],
        [13.5, 51.8], [12, 51.8], [11.8, 52.1],
      ]), 'high', 'The First Partition of Poland (1772) annexes West Prussia and the Netze District, joining Brandenburg to East Prussia for the first time.'),
      snap(ce(1795).year, poly([
        [11.8, 52.1], [13, 53], [14.5, 53.7], [16, 54.3], [17.3, 54.5], [18.3, 54.6], [19.5, 54.8],
        [21, 55.2], [23, 55], [24.3, 54.3],
        [24, 53.2], [22, 52.4], [21.3, 52.0],
        [19, 51.6], [17.5, 51.4], [15.8, 51.9], [15, 52.6],
        [15, 51.8], [16.5, 51.6], [17.5, 51.1], [18.3, 50.6], [18.6, 50.2],
        [17.3, 50.0], [16.2, 50.3], [15.2, 50.6], [14.7, 50.9],
        [13.5, 51.8], [12, 51.8], [11.8, 52.1],
      ]), 'medium', 'Peak extent after the Second (1793) and Third (1795) Partitions of Poland: South Prussia and New East Prussia bring the frontier to Warsaw.'),
      snap(ce(1807).year, poly([
        [12.3, 52.1], [13, 53], [14.5, 53.7], [16, 54.3], [17.3, 54.5], [18.3, 54.6], [19.5, 54.8],
        [21, 55.2], [22.5, 54.7], [21, 53.5],
        [19.5, 53.0], [18.0, 52.6], [16.5, 52.6], [15, 52.6],
        [15, 51.8], [16.5, 51.6], [17.5, 51.1], [18.3, 50.6], [18.6, 50.2],
        [17.3, 50.0], [16.2, 50.3], [15.2, 50.6], [14.7, 50.9],
        [13.5, 51.8], [12.3, 51.9], [12.3, 52.1],
      ]), 'high', 'The Treaty of Tilsit (1807) strips Prussia of its Polish gains (the new Duchy of Warsaw) and its lands west of the Elbe, roughly halving the kingdom.'),
      snap(ce(1815).year, mpoly(
        [[12.3, 52.1], [13, 53], [14.5, 53.7], [16, 54.3], [17.3, 54.5], [18.3, 54.6], [19.5, 54.8],
         [21, 55.2], [22.5, 54.7], [21, 53.5],
         [19.5, 53.0], [18.0, 52.6], [16.9, 51.9], [15.5, 51.9],
         [15, 52.6],
         [15, 51.8], [16.5, 51.6], [17.5, 51.1], [18.3, 50.6], [18.6, 50.2],
         [17.3, 50.0], [16.2, 50.3], [15.2, 50.6], [14.7, 50.9],
         [13.2, 51.0], [12.5, 51.6], [13.0, 51.9], [12.3, 51.9], [12.3, 52.1]],
        [[6.0, 51.9], [6.8, 52.4], [7.5, 52.2], [8.5, 51.9], [9.0, 51.2], [8.3, 50.6], [7.5, 50.1], [6.4, 49.5], [6.0, 49.9], [6.0, 50.6], [6.0, 51.9]],
      ), 'medium', 'The Congress of Vienna (1815) rebuilds Prussia around two blocs: the eastern core, regaining the Grand Duchy of Posen and part of Saxony, and a new western bloc — the Rhine Province and Westphalia.'),
      snap(ce(1866).year, poly([
        [6.0, 51.9], [6.1, 53.2], [7.2, 53.7], [8.5, 54.0], [8.6, 54.9], [9.5, 55.35], [9.65, 55.2],
        [10.9, 54.6], [12.1, 54.4], [13.8, 54.8], [16, 54.7], [18.5, 54.6], [19.6, 54.8], [21.1, 55.8],
        [22.9, 54.35], [22, 53.55], [19.7, 53.2],
        [19, 52.4], [17.5, 51.9], [16, 51.9],
        [17, 50.8], [18.6, 49.9], [17.3, 50.0],
        [14.5, 50.4], [12.1, 50.3], [9.75, 50.3], [7.6, 50.1],
        [6.9, 50.3], [6.0, 50.7], [6.0, 51.9],
      ]), 'medium', 'After the Austro-Prussian War (1866): Hanover, Hesse-Kassel, Nassau, Frankfurt and Schleswig-Holstein annexed, fusing the eastern and western blocs and pushing the southern frontier to the Main, the border of the new North German Confederation.'),
    ],
  },
