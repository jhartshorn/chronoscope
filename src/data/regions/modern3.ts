...
const TABLE: MS[] = [
  ...
  { id: 'croatia', name: 'Croatia', ne: 'Croatia', start: 1991, colour: '#a86a5a', label: 2, pred: ['yugoslavia', 'habsburg-monarchy', 'kingdom-of-croatia'], desc: 'Croatia, independent from Yugoslavia in 1991 after the war of 1991–95; an EU member from 2013. Contemporary boundary from Natural Earth.' },
  { id: 'bosnia-herzegovina', name: 'Bosnia and Herzegovina', ne: 'Bosnia and Herz.', start: 1992, colour: '#8a7a6a', label: 2, alt: ['Bosnia'], pred: ['yugoslavia', 'ottoman-empire', 'kingdom-of-bosnia'], desc: 'Bosnia and Herzegovina, independent from Yugoslavia in 1992; the Bosnian War (1992–95) ended with the Dayton Agreement, which preserved the state as a federation of two entities. Contemporary boundary from Natural Earth.' },
  ...
  { id: 'uzbekistan', name: 'Uzbekistan', ne: 'Uzbekistan', start: 1991, colour: '#4a9a9a', label: 3, pred: ['soviet-union', 'khanate-of-bukhara', 'khanate-of-khiva'], desc: 'Uzbekistan, independent at the dissolution of the USSR in 1991, heir to the great Silk Road cities of Samarkand and Bukhara. Contemporary boundary from Natural Earth.' },
  { id: 'turkmenistan', name: 'Turkmenistan', ne: 'Turkmenistan', start: 1991, colour: '#9a8a4a', label: 3, pred: ['soviet-union', 'khanate-of-khiva'], desc: 'Turkmenistan, independent at the dissolution of the USSR in 1991. Contemporary boundary from Natural Earth.' },
  { id: 'kyrgyzstan', name: 'Kyrgyzstan', ne: 'Kyrgyzstan', start: 1991, colour: '#7a9a7a', label: 2, pred: ['soviet-union', 'khanate-of-kokand'], desc: 'Kyrgyzstan, independent at the dissolution of the USSR in 1991. Contemporary boundary from Natural Earth.' },
  { id: 'tajikistan', name: 'Tajikistan', ne: 'Tajikistan', start: 1991, colour: '#8a6a8a', label: 2, pred: ['soviet-union', 'khanate-of-bukhara'], desc: 'Tajikistan, independent at the dissolution of the USSR in 1991. Contemporary boundary from Natural Earth.' },
  ...
  { id: 'sri-lanka', name: 'Sri Lanka', ne: 'Sri Lanka', start: 1948, colour: '#5a9a7a', label: 3, alt: ['Ceylon'], pred: ['british-empire', 'kingdom-of-kandy'], desc: 'Sri Lanka (Ceylon until 1972), independent from Britain in 1948 — an island whose recorded statehood reaches back over two millennia. Contemporary boundary from Natural Earth.' },
