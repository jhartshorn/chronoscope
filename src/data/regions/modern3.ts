...
const TABLE: MS[] = [
  ...
  { id: 'laos', name: 'Laos', ne: 'Laos', start: 1953, colour: '#6a9a6a', label: 2, pred: ['french-colonial-empire', 'khmer-empire'], desc: 'Laos, independent from France in 1953, successor to the kingdom of Lan Xang. Contemporary boundary from Natural Earth.' },
