...
const TABLE: MS[] = [
  ...
  { id: 'sweden', name: 'Sweden', ne: 'Sweden', start: 1523, colour: '#4a7ab0', label: 3, pred: ['kalmar-union'] },
  ...
  { id: 'norway', name: 'Norway', ne: 'Norway', start: 1905, colour: '#5a8ab0', label: 3, pred: ['kingdom-of-norway', 'kalmar-union'] },
  { id: 'denmark', name: 'Denmark', ne: 'Denmark', start: 1849, colour: '#a85a5a', label: 2, pred: ['kalmar-union'] },
  ...
  { id: 'bulgaria', name: 'Bulgaria', ne: 'Bulgaria', start: 1908, colour: '#5a8a6a', label: 2, pred: ['ottoman-empire', 'second-bulgarian-empire'], desc: 'Bulgaria, fully independent of the Ottomans in 1908, with borders essentially fixed since 1940. A Warsaw Pact member 1955–1991 and EU member from 2007. Contemporary boundary from Natural Earth.' },
