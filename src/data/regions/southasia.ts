...
export const SOUTH_ASIA_ENTITIES: HistoricalEntity[] = [
  ...
  },
  {
    ...
    colour: '#4a9a8a',
    labelImportance: 2,
    predecessorIds: ['anuradhapura', 'chola-empire'],
    description:
      'The Sinhalese kingdom that reunified Sri Lanka after Vijayabahu I’s rebellion threw off Chola rule (completed 1070), moving the capital to Polonnaruwa. Parakramabahu I’s reign (1153–86) was a golden age of monumental irrigation works and even naval expeditions abroad, before Kalinga Magha’s devastating 1215 invasion broke the kingdom and drove the Sinhalese court progressively south-west.',
    sources: [src('De Silva 1981, A History of Sri Lanka')],
    snapshots: [
      snap(ce(1055).year, poly([[80.3, 6.0], [81.6, 6.3], [81.4, 7.3], [80.2, 7.0], [80.3, 6.0]]), 'low', 'Vijayabahu I’s rebellion begins from the southern Ruhuna refuge region.'),
      snap(ce(1070).year, poly([[79.8, 5.8], [81.9, 6.1], [81.8, 9.2], [80, 9.8], [79.7, 8], [79.8, 5.8]]), 'medium', 'Vijayabahu completes the reconquest and reunifies the whole island, moving the capital to Polonnaruwa.'),
      snap(ce(1153).year, poly([[79.8, 5.8], [81.9, 6.1], [81.8, 9.2], [80, 9.8], [79.7, 8], [79.8, 5.8]]), 'medium', 'Parakramabahu I’s golden age: the whole island under one crown.'),
      snap(ce(1215).year, poly([[79.8, 6.0], [80.8, 6.0], [81.2, 7.5], [80.5, 8.5], [79.8, 7.5], [79.8, 6.0]]), 'high', 'Kalinga Magha’s invasion sacks Polonnaruwa; the Sinhalese court retreats to the island’s south-west.'),
    ],
  },
  {
    id: 'kingdom-of-kandy',
    ...
    colour: '#7a9a4a',
    labelImportance: 3,
    successorIds: ['sri-lanka'],
    description:
      'Sri Lanka’s last independent kingdom, in the central highlands, which became the primary seat of Sinhalese kingship as the coastal Kotte and Sitawaka kingdoms fell under Portuguese sway. It held the interior against Portuguese and then Dutch control of the coastal lowlands for over two centuries, repelling repeated invasions, until the British deposed the last king and annexed it by the 1815 Kandyan Convention — the end of over two millennia of Sinhalese monarchy.',
    sources: [
      src('De Silva 1981, A History of Sri Lanka'),
      src('Dewaraja 1988, The Kandyan Kingdom of Sri Lanka, 1707–1782'),
    ],
    snapshots: [
      snap(ce(1469).year, poly([[80.4, 7.0], [80.9, 7.0], [81.0, 7.5], [80.5, 7.6], [80.4, 7.0]]), 'low', 'Founding as a minor central-highland principality.'),
      snap(ce(1592).year, poly([[80.0, 6.7], [81.0, 6.7], [81.6, 8.0], [80.8, 8.3], [80.0, 7.5], [80.0, 6.7]]), 'medium', 'Becomes the primary Sinhalese kingdom as Kotte and Sitawaka fall to Portuguese control.'),
      snap(ce(1660).year, poly([[80.2, 6.9], [81.0, 6.9], [81.3, 7.8], [80.6, 8.1], [80.2, 7.5], [80.2, 6.9]]), 'medium', 'Restricted to the interior highlands after the Dutch take the coastal lowlands from Portugal (1656–58).'),
      snap(ce(1803).year, poly([[80.3, 7.0], [80.9, 7.0], [81.1, 7.7], [80.6, 7.9], [80.3, 7.4], [80.3, 7.0]]), 'high', 'Repels the First Kandyan War (1803), shortly before Britain finally annexes the kingdom in 1815.'),
    ],
  },
  {
    id: 'delhi-sultanate',
